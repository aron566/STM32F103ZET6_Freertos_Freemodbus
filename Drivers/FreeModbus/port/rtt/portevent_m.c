...
/* ----------------------- Defines ------------------------------------------*/
/* ----------------------- Variables ----------------------------------------*/
static StaticSemaphore_t    xMasterRunRes;       /*    信号量          */
static SemaphoreHandle_t    master_semaphore_Handle;
static StaticEventGroup_t   xMasterOsEvent;      /*  事件存储，事件组  */
static EventGroupHandle_t   master_event_Handle; /*  事件标志组句柄    */
...
void vMBMasterErrorCBRespondTimeout(UCHAR ucDestAddress, const UCHAR* pucPDUData,
     ...
     */
    /*设置事件标志组 EV_MASTER_ERROR_RESPOND_TIMEOUT 置1*/
...
void vMBMasterErrorCBReceiveData(UCHAR ucDestAddress, const UCHAR* pucPDUData,
     ...
     * If you don't use OS, you can change it.
     */
    /*设置事件标志组 EV_MASTER_ERROR_RECEIVE_DATA 置1*/
...
void vMBMasterErrorCBExecuteFunction(UCHAR ucDestAddress, const UCHAR* pucPDUData,
     ...
     * If you don't use OS, you can change it.
     */
    /*设置事件标志组 EV_MASTER_ERROR_EXECUTE_FUNCTION 置1*/
...
void vMBMasterCBRequestScuuess( void ) {
     ...
     * If you don't use OS, you can change it.
     */
    /*设置事件标志组 EV_MASTER_PROCESS_SUCESS 置1*/
